...
posts = Blueprint('posts', __name__) # "posts" is the name of the blueprint


# We change app.routes to posts.route cuz we using it as a posts blueprint instance right now
